      ...
      <div className="relative w-full">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-x-28 gap-y-14 base:w-[90%] md:w-[80%] mx-auto relative z-50">
          <div className="base:order-1">
            <h1 className="text-[200px] text-[#FF5800] text-opacity-40 text-center font-thin">
              01
            </h1>
          </div>
          <div className="base:order-2 border-2 border-[#727272] rounded-3xl border-opacity-25 bg-[#111113] base:p-4 md:p-14">
          ...
          <div className="base:order-4 md:order-4 lg:order-3 xl:order-3 border-2 border-[#727272] rounded-3xl border-opacity-25 bg-[#111113]  base:p-4 md:p-14">
          ...
          <div className="base:order-6 border-2 border-[#727272] rounded-3xl border-opacity-25 bg-[#111113] base:p-4 md:p-14">
            <h2 className="text-[30px] font-thin">
          ...
          <div className="base:order-8 md:order-8 lg:order-7 xl:order-7 border-2 border-[#727272] rounded-3xl border-opacity-25 bg-[#111113] base:p-4 md:p-14">
