...
const AboutSection = () => {
  return (
    <>
      ...
      <div className="mt-40 text-center base:w-[90%] xl:w-[50%] mx-auto">
        <p className="leading-9 pb-10 text-[20px] font-thin">
          Proton Perpetual is a Delaware-based holding company with a robust
          portfolio of income-generating real estate assets. In partnership with
          Finix196s RWA tokenization platform, we are transforming how
          individual investors access and profit from real estate investments
