...
import { checkBalance, investNow } from "../blockchain/commonFunction";
...
const Calculate = () => {
  ...
  const formatTimeLeft = (time) => {
    ...
    return (
      <Box className="text-center w-[] grid base:grid-cols-2 md:grid-cols-7 base:gap-4 md:gap-0 items-center">
        <span className="time-part md:text-[18px] 2xl:text-[35px] font-light bg-white bg-opacity-5 p-3 text-center rounded-xl text-[#FF5800]">
          {days}d
        </span>{" "}
