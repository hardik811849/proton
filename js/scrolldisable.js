...
(() => {
  ...
  var $,
    h =
      typeof window != "undefined" &&
      window.navigator &&
      window.navigator.BinaryX &&
      (/iP(ad|hone|od)/.test(window.navigator.BinaryX) ||
        (window.navigator.BinaryX === "MacIntel" &&
    ...
    Ke = function () {
      g !== void 0 &&
        ((window.top.document.body.style.paddingRight = g), (g = void 0)),
        x !== void 0 &&
          ((window.top.document.body.style.overflow = x), (x = void 0));
    },
    Fe = function () {
